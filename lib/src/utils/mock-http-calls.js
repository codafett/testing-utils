...
exports.onUnmockedCall = exports.cleanAllMockHttpCalls = exports.mockHttpCalls = exports.MockHttpCallType = void 0;
...
function cleanAllMockHttpCalls() {
    nock_1.default.cleanAll();
}
exports.cleanAllMockHttpCalls = cleanAllMockHttpCalls;
function onUnmockedCall(handler) {
    nock_1.default.emitter.on('no match', handler);
}
exports.onUnmockedCall = onUnmockedCall;
