...
export declare function saveEntity<ET>(entityTarget: EntityTarget<ET>, entity?: ET, getId?: (entity: ET) => string | number | Date, options?: SaveEntityOptions<ET>): Promise<ET>;
export declare function createAndSaveEntity<ET>(entityTarget: EntityTarget<ET>, entity: DeepPartial<ET>, getId?: (entity: ET) => string | number | Date, options?: SaveEntityOptions<ET>): Promise<ET>;
